...
class Order extends Model
{
    ...
    protected $fillable = [
        'code', 'user_id', 'status', 'grand_total', 'item_count','order_date',
		'payment_due', 'payment_status', 'payment_method','base_total_price','tax_amount','tax_percent','discount_amount','discount_percent','shipping_cost',
        'first_name', 'last_name', 'address','address2', 'province_id' , 'city', 'country', 'post_code', 'phone_number', 'email', 'notes','shipping_courier',
